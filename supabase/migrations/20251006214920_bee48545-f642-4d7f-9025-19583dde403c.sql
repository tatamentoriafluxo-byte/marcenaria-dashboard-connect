-- ============================================
-- ETAPA 3: EXPANDIR PROJECTS E CRIAR RELACIONAMENTOS
-- ============================================

-- Adicionar relacionamentos à tabela projects
...
CREATE INDEX idx_producao_project ON public.producao(project_id);
CREATE INDEX idx_producao_marceneiro ON public.producao(marceneiro_id);
CREATE INDEX idx_montagem_project ON public.montagem(project_id);
CREATE INDEX idx_montagem_montador ON public.montagem(montador_id);
...
CREATE INDEX idx_transacoes_categoria ON public.transacoes_financeiras(categoria);
...
CREATE INDEX idx_itens_compra_material ON public.itens_compra(material_id);
